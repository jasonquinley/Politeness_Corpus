...
#### PACKAGE IMPORTS ###########################################################
from politeness2.constants import POLITENESS_CLASSIFIER_PATH
from politeness2 import helpers
from politeness2.vectorizer import PolitenessFeatureVectorizer
...
class Classifier2(object):
    ...
    def predict(self, doc_path):
        ...
        for i, doc in enumerate(parsed_docs):
            ...
            output.append({str(doc['sentences'][0]): polite[i]})
        ...
        output.append({"document": np.mean(polite)})
        return output
